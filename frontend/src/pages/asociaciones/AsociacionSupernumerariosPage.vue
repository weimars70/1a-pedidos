  ...
  <q-page class="sn-page q-pa-lg">
    ...
    <div class="page-header q-mb-lg">
      <div class="page-title-area">
        <q-icon name="people_outline" color="primary" size="28px" class="q-mr-sm" />
        <h5 class="q-ma-none text-weight-bold text-grey-9">Asociación Supernumerarios Auxiliares</h5>
      </div>
      <q-breadcrumbs class="text-caption q-mt-xs" active-color="primary">
        ...
        <q-breadcrumbs-el label="Supernumerarios Auxiliares" />
      </q-breadcrumbs>
    </div>
