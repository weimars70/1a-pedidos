...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'contratos/registrar-terminacion', component: () => import('pages/contratos/RegistrarTerminacionPage.vue') },
      { path: 'contratos/registrar-disminucion', component: () => import('pages/contratos/RegistrarDisminucionPage.vue') },
